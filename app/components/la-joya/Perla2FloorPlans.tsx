...
const DEFAULT_PLANS: Plan[] = [
    ...
    title: "1+0",
    size: "52 m² kapalı • 89 m² kullanım",
    variants: [
      {
        name: "Stüdyo Penthouse",
        image: "/la-joya-plan/4.png",
        areas: [
          { label: "Salon + Mutfak", value: "32 m²" },
          { label: "WC / Banyo", value: "6 m²" },
          { label: "Balkon", value: "7 m²" },
          { label: "Çatı Terası", value: "37 m²" },
          { label: "Ortak Kullanım Alanı", value: "7 m²" },
        ],
        totals: { kapali: "52 m²", kullanim: "89 m²" },
        gallery: [],
      },
    ],
  },
  {
    id: "lj-1plus1-loft",
    title: "1+1",
    size: "71 m² kapalı • 78 m² kullanım",
    variants: [
      {
        name: "Loft Daire",
        image: "/la-joya-plan/5.png",
        areas: [
          { label: "Oturma Odası", value: "38 m²" },
          { label: "Antre", value: "2 m²" },
          { label: "WC", value: "3 m²" },
          { label: "Yatak Odası", value: "13 m²" },
          { label: "WC / Banyo", value: "4,50 m²" },
          { label: "Giyinme Odası", value: "3,5 m²" },
          { label: "Teras", value: "7 m²" },
          { label: "Ortak Kullanım Alanı", value: "7 m²" },
        ],
        totals: { kapali: "71 m²", kullanim: "78 m²" },
        gallery: [],
      },
    ],
  },
  {
    ...
    title: "2+1",
    size: "98 m² kapalı • 172 m² kullanım",
    variants: [
      {
        name: "Penthouse Daire",
        image: "/la-joya-plan/6.png",
        areas: [
          { label: "Salon + Mutfak", value: "38 m²" },
          { label: "Antre", value: "2 m²" },
          { label: "WC / Banyo", value: "6 m²" },
          { label: "Yatak Odası 1", value: "14 m²" },
          { label: "Yatak Odası 2", value: "14 m²" },
          { label: "Teras", value: "14 m²" },
          { label: "Çatı Terası", value: "74 m²" },
          { label: "Ortak Kullanım Alanı", value: "10 m²" },
        ],
        totals: { kapali: "98 m²", kullanim: "172 m²" },
        gallery: [],
      },
    ],
  },
