...
,
  {
    ...
    badge: "Video",
    content: {
      customHeadline: "La Joya Residence Tour",
      tagline: "A scene where simplicity and modern lines meet the sea.",
      bullets: [
        "Minimal architecture inspired by the rhythm of the coast",
        "Spacious social areas and walking routes",
        "Natural lighting scenarios at sunset",
      ],
      primaryCta: { label: "Explore Project", href: "/en/la-joya" },
      secondaryCta: { label: "Contact Us", href: "/en/contact" },
    },
  },
  {
    ...
    badge: "Video",
    content: {
      customHeadline: "Geçitkale Land Project Overview",
      tagline: "A calm rhythm surrounded by greenery and water elements.",
      bullets: [
        "Landscape design that enhances outdoor living",
        "Comfort-oriented planning and circulation",
        "Rich service and facility options",
      ],
      primaryCta: { label: "Learn More", href: "/en/gecitkale" },
      secondaryCta: { label: "Sales Team", href: "/en/team" },
    },
  },
  {
    id: 3,
    ...
    badge: "Video",
    content: {
      customHeadline: "Northern Cyprus Introduction Video",
      tagline: "A well-designed living ecosystem that gains value over time.",
      bullets: [
        "Flexible payment and delivery options",
        "High occupancy goals and management",
        "Long-term, value-oriented approach",
      ],
      primaryCta: { label: "About Us", href: "/en/contact" },
      secondaryCta: { label: "Other Projects", href: "/en/projects" },
    },
  },
];
