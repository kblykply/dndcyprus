...
export default function DefaultHero({
  ...
  kicker = "DND Cyprus",
  title = "DND Istanbul Office",
  subtitle =
    "Our Turkey-based consulting team provides transparent, structured, and end-to-end support for investors interested in our Cyprus projects.",
  align = "center",
}: Props) {
      ...
      >
        ...
        >
          ...
          <motion.h1
            ...
            initial="hidden"
            animate="show"
            className="font-bold text-white drop-shadow-lg text-4xl sm:text-5xl lg:text-6xl"
          >
            {title}
          </motion.h1>
