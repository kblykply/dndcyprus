...
export default function ContactHeroGlass({
 kicker = "Contact",
title = "Get in Touch",
subtitle = "Contact us to learn more about our projects and investment opportunities.",

  bgImage = "/lagoon-verde/1.jpg",
primary = { label: "Send Message", href: "#form" },
secondary = { label: "Our Projects", href: "/en/projects" },
