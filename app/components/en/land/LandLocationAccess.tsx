...
subhead:
  "Close to daily amenities, the coastline and main road connections. The times below represent approximate driving durations.",
tone: "light",
...
driveTimes: [
  ...
  { label: "Famagusta", minutes: 18 },
  { label: "Ercan Airport", minutes: 25 },
  { label: "İskele Center", minutes: 15 },
],

accessNotes: [
  "Close to the asphalt road with quick access to regional connections.",
  "Low slope; regular parcel shape allowing easy site planning.",
  "Quiet surroundings; an emerging residential area.",
],
