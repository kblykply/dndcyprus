...
export default function Perla2Overview({
 title = "Lagoon Verde Overview",
lead =
  "Lagoon Verde is a prestigious residential project in Bahçeler, Iskele that redefines holiday and daily life with its unique lagoon pool concept, modern architecture, and rich social amenities. Its location close to the sea and city facilities offers a balanced option for both investment and living.",
highlights = [
  "Expansive lagoon pool with an island-style pool concept",
  "Fitness center, children’s playground, beauty center, and mini golf",
  "Aquapark, pool bar, restaurant, supermarket, and pharmacy",
  "Mariachi Beach Club membership and privileges just 7 minutes away",
],
...
{ label: "Investment-Friendly", color: ORANGE },
