...
export default function Perla2Location({
 title = "Lagoon Verde Location",
subtitle = "Bahçeler, Iskele — a location close to the sea and daily amenities.",
address = "Bahçeler, Iskele, North Cyprus",
lat = 35.228781,
lng = 33.880673,
embedSrc =
  "https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15764!2d33.880673!3d35.228781!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzXCsDEzJzQzLjYiTiAzM8KwNTInNTAuNCJF!5e0!3m2!1sen!2s!4v1696462350000",
nearby = [
  { label: "Long Beach" },
  { label: "Markets & Restaurants" },
  { label: "Coastal Walking Path" },
  { label: "Iskele Center" },
],
grayscale = false,
distances = [
  ...
  { label: "Hospital", km: 10, accent: "teal" },
  { label: "Gazimağusa (Famagusta)", km: 15, accent: "orange" },
  { label: "Ercan Airport", km: 45, accent: "teal" },
],
  ...
  return (
    <section
      aria-label="Lagoon Verde — Location"
...
Open on Map            </a>
        ...
        >
          <div className="aspect-[16/9]">
            <iframe
              title="Lagoon Verde location map"
              src={iframeSrc}
              loading="lazy"
