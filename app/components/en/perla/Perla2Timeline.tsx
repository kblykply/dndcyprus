...
/** Allow CSS variables on inline styles without using `any`. */
...
eyebrow = "November 2024 Update",
title = "La Joya Perla Latest Construction Update",
description = "Construction at the La Joya Perla project, scheduled for delivery in November 2026, is progressing rapidly.",

  video = {
    src: "https://www.youtube.com/embed/YSy7WB056Fg?si=-HLY_3T_kk2bIt_j",
    type: "youtube",
    title: "La Joya Perla II – Latest Construction Update",
  },
  cta,
}: Props) {
  ...
  />
  The footage was recorded during the site supervisor’s weekly site tour.
</li>
<li className="flex items-start gap-2">
  <span
    className="mt-1 inline-block h-1.5 w-1.5 rounded-full"
  ...
  />
  Dates are for promotional purposes only; the official handover schedule should be confirmed with the sales team.
</li>
