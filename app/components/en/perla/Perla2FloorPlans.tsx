...
export default function Perla2FloorPlans({
  title = "La Joya Perla Floor Plans",
subtitle = "Sample plans for apartment types. For detailed typologies and dimensions, please contact our sales team.",
...
const DEFAULT_PLANS: Plan[] = [
  {
    id: "ljp-1plus0",
    title: "1+0",
    size: "33.60–38.90 m² covered • 45.60–50.90 m² total usable area",
    variants: [
      {
        name: "Studio Residence (Grand)",
        image: "/perla-plans/1.png",
        areas: [
          { label: "Living Room + Kitchen", value: "26 m²" },
          { label: "WC - Bathroom", value: "4 m²" },
          { label: "Balcony", value: "3.60 m²" },
      ...
      },
      {
        ...
        image: "/perla-plans/1.png",
        areas: [
          { label: "Living Room + Kitchen", value: "29.25 m²" },
          { label: "WC - Bathroom", value: "5.45 m²" },
          { label: "Balcony", value: "4.20 m²" },
          { label: "Garden", value: "6 m²" },
          { label: "Common Area", value: "6 m²" },
        ],
  ...
  },
  {
    id: "ljp-1plus1-loft",
    title: "1+1",
    size: "43.5–49.57 m² covered • 73.5–81.95 m² total usable area",
    variants: [
      {
        name: "Loft Residence (Grand)",
        image: "/perla-plans/2.png",
        areas: [
          { label: "Living Room + Kitchen", value: "23 m²" },
          { label: "WC - Bathroom", value: "4 m²" },
          { label: "Bedroom", value: "13.5 m²" },
          { label: "Balcony", value: "3 m²" },
          { label: "Roof Terrace", value: "23 m²" },
          { label: "Common Area", value: "7 m²" },
        ],
      ...
      },
      {
        ...
        image: "/perla-plans/2.png",
        areas: [
          { label: "Living Room + Kitchen", value: "25.38 m²" },
          { label: "WC - Bathroom", value: "5.45 m²" },
          { label: "Bedroom", value: "15.24 m²" },
          { label: "Balcony", value: "3.5 m²" },
          { label: "Roof Terrace", value: "25.38 m²" },
          { label: "Common Area", value: "7 m²" },
        ],
  ...
  },
  {
    ...
    title: "2+1",
    size: "61 m² covered • 126 m² total usable area",
    variants: [
      {
        name: "Luxury Suite Residence",
        image: "/perla-plans/3.png",
        areas: [
          { label: "Living Room + Kitchen", value: "27 m²" },
          { label: "WC - Bathroom", value: "4 m²" },
          { label: "Corridor", value: "2 m²" },
          { label: "Bedroom 1", value: "12 m²" },
          { label: "Bedroom 2", value: "13 m²" },
          { label: "Balcony", value: "3 m²" },
          { label: "Roof Terrace", value: "58 m²" },
          { label: "Common Area", value: "7 m²" },
        ],
