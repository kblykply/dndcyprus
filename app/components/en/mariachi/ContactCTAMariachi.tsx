// app/components/mariachi/ContactCTAMariachi.tsx
"use client";
...
export default function ContactCTAMariachi({
 title = "Mariachi Beach Club",
subtitle =
  "Bahçeler, İskele — a five-star beach & pool experience where the Mediterranean sun meets Latin spirit. Restaurant with a Latino-inspired menu, 2 bars, 4 jacuzzi pools and live DJ performances.",
buttonText = "Make a Reservation",
buttonHref = "/en/contact",
bgImage = "/mariachi/1.jpg", // use your own image path (public/)
overlayOpacity = 0.42,
fullHeight = true,
highlights = [
  "Restaurant (Latino-inspired menu)",
  "Pool + 4 jacuzzis",
  "2 bars",
  ...
  return (
    <section
      aria-label="Mariachi Beach Club — İletişim & Rezervasyon"
      className={`relative overflow-hidden ${fullHeight ? "min-h-[50vh]" : "min-h-[50vh]"}`}
      style={
        {
    ...
    >
      ...
      {bgImage && (
        <div className="absolute inset-0">
          <Image
            src={bgImage}
            alt="Mariachi Beach Club arka plan"
            fill
            priority
            sizes="100vw"
