...
const MARIACHI_DEFAULTS = {
  ...
  title: "Mariachi Beach Club Benefits for DND Homeowners",
subtitle: "Sea & sun by day, rhythm by night — all in one place.",
...
export default function MariachiPerks() {
  ...
  const perks: Perk[] = [
    {
  title: "Free Entry",
  desc: "No entrance fee for residents and their guests.",
  icon: <Waves className="h-5 w-5" />,
},
{
  title: "10% Discount",
  desc: "Extra benefits on restaurant, pool bar, and sunbed/cabana spend.",
