...
export default function MariachiHighlights({
 title = "Amenities & Privileges",
subtitle = "All-day beach enjoyment, cabana comfort, a restaurant & pool bar, and evening DJ performances.",
  ...
  {
    title: "Pool & Beach",
    desc: "Spacious sunbathing areas with shower and towel service.",
    image: "/mariachi/2.jpg",
    icon: <Waves className="h-5 w-5" />,
  },
  {
    title: "Cabanas",
    desc: "Comfortable shaded spaces throughout the day; reservations recommended.",
    image: "/mariachi/6.jpg",
    icon: <Umbrella className="h-5 w-5" />,
  },
  {
    title: "Restaurant & Pool Bar",
    desc: "Refreshing flavors by day, signature cocktails in the evening.",
    image: "/mariachi/3.jpg",
    icon: <Martini className="h-5 w-5" />,
  },
  {
    title: "DJ Nights",
    desc: "Live performances from sunset into the late hours.",
    image: "/dj.jpg",
    icon: <Music4 className="h-5 w-5" />,
  },
  {
    title: "Spa & Wellness",
    desc: "Massage and treatment services (depending on the project).",
    image: "/spa.jpg",
    icon: <Sparkles className="h-5 w-5" />,
  },
  {
    title: "Coastal Experience",
    desc: "Mediterranean breeze and scenic seaside walks.",
    image: "/sea.jpg",
