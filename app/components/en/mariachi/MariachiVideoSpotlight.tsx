...
export default function MariachiVideoSpotlight({
 title = "Promo Video",
subtitle =
  "Discover the Mariachi Beach Club atmosphere in a short video: cabanas, pool & beach areas, all-day enjoyment and evening DJ performances.",
badge = "VIDEO",
embedUrl = "https://www.youtube.com/embed/AobeR8p2Aq4?si=Z_AaUhavwKNYLgNX",
videoSrc = "",
poster = "/mariachi/1.jpg",
primaryCta = { label: "Book a Pavilion", href: "/en/contact" },
secondaryCta = { label: "All Videos", href: "https://www.youtube.com/@dndcyprus" },
highlights = [
  { k: "Experience", v: "Daytime & Night" },
  { k: "Spaces", v: "Beach • Pool • Pavilions" },
  { k: "Food & Drinks", v: "Restaurant & Pool Bar" },
],
