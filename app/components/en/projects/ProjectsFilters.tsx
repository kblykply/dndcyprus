...
const STATUS_TABS: { key: ProjectStatus; label: string; accent?: "teal" | "orange" }[] = [
  { key: "All",      label: "All",        accent: "teal" },
  { key: "Ongoing",  label: "Ongoing",  accent: "orange" },
  { key: "Upcoming", label: "Upcoming",     accent: "teal" },
  { key: "Completed",label: "Completed",  accent: "orange" },
];
