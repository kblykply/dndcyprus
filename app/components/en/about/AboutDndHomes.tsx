...
export default function AboutDndHomes({
 kicker = "Born in the USA, living in North Cyprus",
videoId,
poster,
videoTitle = "DND Homes Introduction Video",
startAt = 0,
heading = "Discover our projects and living concept.",
description = "DND Homes develops high-end residences in prime locations in Massachusetts (USA) and North Cyprus.",
...
<ul className="mt-3 grid gap-2 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl">
  <BlurChip>
    <Dot /> Boston-based brand; 120 completed projects in Massachusetts.
  </BlurChip>
  <BlurChip>
    <Dot /> A vision of {" "}
    <strong className="font-semibold text-white">30,000+ homes</strong> in North Cyprus.
  </BlurChip>
  <BlurChip>
    <Dot /> Bafra tourism investment and the exclusive{" "}
    <strong className="font-semibold text-white">Mariachi Beach Club</strong> privileges.
  </BlurChip>
  <BlurChip>
    <Dot /> Head offices in the USA &amp; TRNC; American quality standards.
  </BlurChip>
</ul>

{/* CTAs */}
<div className="mt-3 inline-flex flex-wrap gap-2 rounded-xl bg-black/25 px-2.5 py-2 ring-1 ring-white/15 backdrop-blur-md">
  <PrimaryCTA href="https://dnd-homes.com/">DND Homes Website</PrimaryCTA>
  <SecondaryCTA href="/en/projects">North Cyprus Projects</SecondaryCTA>
</div>
            </div>
            {/* Badge (top-right) */}
        ...
        <BlurChipMobile>
  <Dot /> 120 completed projects in Massachusetts
</BlurChipMobile>
<BlurChipMobile>
  <Dot /> Vision of <strong className="font-semibold text-black">30,000+ homes</strong> in TRNC
</BlurChipMobile>
<BlurChipMobile>
  <Dot /> Bafra investment &amp; Mariachi Beach Club
</BlurChipMobile>
<BlurChipMobile>
  <Dot /> USA &amp; TRNC offices; high quality standards
</BlurChipMobile>
