...
const PROJECT_JSON_LD = {
  ...
  url: `${SITE_URL}/en/perla-ii`,
  description:
    "La Joya Perla II is a residential project in Bahçeler, Iskele that redefines modern living with its architecture, planning, and social amenities.",
  image: `${SITE_URL}/perla-ii/1.jpg`,
  address: {
    "@type": "PostalAddress",
  ...
  geo: { "@type": "GeoCoordinates", latitude: 35.2869, longitude: 33.9235 },
  numberOfAccommodationUnits: { "@type": "QuantitativeValue", value: 128 },
};
...
export default function Perla2Facts({
 title = "La Joya Perla II Key Facts",
subtitle = "Quickly explore the core features of the project.",
facts = [
  { label: "Location", value: "Bahçeler, Iskele", accent: "teal" },
  { label: "Delivery", value: "May 2027", accent: "orange" },
  { label: "Type", value: "Residential (Residence)", accent: "teal" },
  { label: "Number of Units", value: "128", accent: "orange" }, // update if needed
  { label: "Land Area", value: "8,800 m²", accent: "teal" },    // update if needed
