...
export default function Perla2Location({
 title = "La Joya Perla II Location",
...
grayscale = false,
distances = [
  { label: "School", km: 1.5, accent: "teal" },
  { label: "Ercan Airport", km: 49, accent: "orange" },
  { label: "Beach Club", m: 700, accent: "teal" },
  { label: "Shopping Mall", km: 2.5, accent: "orange" },
  { label: "Gazimağusa (Famagusta)", km: 22, accent: "teal" },
  { label: "Hospital", km: 3, accent: "orange" },
],
