...
export default function Perla2Overview({
 title = "La Joya Perla II Overview",
lead =
  "La Joya Perla II is a residential project in Bahçeler, Iskele that redefines modern living with its architecture, planning, and social amenities. Its location close to the sea and city facilities offers a balanced option for both investment and living.",
highlights = [
  "Easy access to the long coastline, markets, and restaurants",
  "Efficient layouts and façade design that maximizes natural light",
  "Swimming pool, fitness, green areas, and parking",
  "On-time delivery and a transparent communication approach",
]
,
