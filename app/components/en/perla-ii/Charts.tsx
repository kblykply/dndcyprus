...
const DEFAULT_ITEMS: Amenity[] = [
  {
    label: "Restaurant",
    desc:
      "Enjoy a carefully crafted chef’s menu for a truly delightful dining experience.",
    icon: Utensils,
    accent: "teal",
  },
  {
    label: "Mini Market",
    desc: "Quick and easy on-site access to your daily essentials.",
    icon: ShoppingCart,
    accent: "orange",
  },
  {
    label: "Aqua Park",
    desc: "Combine action and fun and enjoy energetic, unforgettable days.",
    icon: LifeBuoy,
    accent: "teal",
  },
  {
    label: "Tennis Court",
    desc: "Join enjoyable matches on courts designed for sports enthusiasts.",
    icon: Flag,
    accent: "orange",
  },
  {
    label: "Underground Parking Garage",
    desc: "Park your car safely and stay protected from weather conditions.",
    icon: Car,
    accent: "teal",
  },
  {
    label: "Indoor & Outdoor Swimming Pool",
    desc: "Holiday vibes in every season with both indoor and outdoor pools.",
    icon: Waves,
    accent: "orange",
  },
  {
    label: "Spa & Gym",
    desc:
      "Spa and fitness facilities designed to keep your wellbeing and comfort at the forefront.",
    icon: Dumbbell,
    accent: "teal",
  },
  {
    ...
    desc:
      "Professional services at La Joya Perla II to complete your look in style.",
    icon: Scissors,
    accent: "orange",
  },
  {
  ...
  },
  {
    ...
    desc:
      "Safe and enjoyable playtime in specially designed outdoor areas.",
    icon: Puzzle,
    accent: "orange",
  },
  {
    ...
    desc:
      "An open court for enjoyable games that strengthen team spirit.",
    icon: Trophy,
    accent: "teal",
  },
]
...
export default function Perla2AmenitiesSection({
 title = "La Joya Perla II — Amenities",
subtitle =
  "Within the La Joya Perla II complex, you’ll find many facilities designed for your comfort and enjoyment.",
