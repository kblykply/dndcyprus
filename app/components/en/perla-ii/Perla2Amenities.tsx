...
const TOUR_SRC = "/tours/perla-ii/app-files/index.html";
// Bigger viewer: use clamp to be large yet safe on small screens
const VIEW_HEIGHT = "clamp(460px, 86vh, 1100px)";
const BORDER_RADIUS = 20;

// Visuals
const BG_IMAGE = "/perla-ii/1.jpg";
const POSTER_IMAGE = "/perla-ii-in/6.jpg";
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 py-14 sm:py-18 lg:py-22">
        ...
        >
          ...
          <div className="mb-6 text-center">
            ...
            >
            Explore the project in panoramic view. Click the play button below to begin and navigate in full-screen mode.
            </motion.p>
          </div>
