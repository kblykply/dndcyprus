...
export default function ContactCTAPerlaII({
  title = "La Joya Perla II",
subtitle =
  "Bahçeler, Iskele — close to the sea and daily amenities. Studio, 1+1 and 2+1 options with spacious balconies, terraces and roof terraces.",
buttonText = "Get a Price",
buttonHref = "/en/contact",
bgImage = "/perla-ii/1.jpg", // use your own image path
overlayOpacity = 0.4,
fullHeight = false,
highlights = [
  "Lagoon & island pools",
  ...
  return (
    <section
      aria-label="La Joya Perla II — İletişim & Broşür"
