...
export default function Perla2FloorPlans({
 title = "La Joya Perla II Floor Plans",
subtitle =
...
const DEFAULT_PLANS: Plan[] = [
  {
    id: "ljp2-1plus0",
    title: "1+0",
    size: "33.60 m² covered • 45.60 m² total usable area",
    variants: [
      {
  ...
  },
  {
    id: "ljp2-1plus1-loft",
    title: "1+1",
    size: "43.5 m² covered • 73.5 m² total usable area",
    variants: [
      {
  ...
  },
  {
    ...
    title: "2+1",
    size: "67.5 m² covered • 112–135 m² total usable area",
    variants: [
      {
        name: "2+1 Luxury Garden Suite (Grand)",
        image: "/perla-ii-plans/10.png",
        areas: [
          { label: "Living Room + Kitchen", value: "30 m²" },
          { label: "WC - Bathroom", value: "4.5 m²" },
          { label: "Corridor", value: "2.5 m²" },
          { label: "Bedroom 1", value: "11.5 m²" },
          { label: "Bedroom 2", value: "11.5 m²" },
          { label: "Terrace", value: "7.5 m²" },
          { label: "Garden", value: "23.5 m²" },
          { label: "Pool", value: "9 m²" },
      ...
      },
      {
        ...
        areas: [
          ...
          { label: "Bedroom 2", value: "11.5 m²" },
          { label: "Terrace", value: "7.5 m²" },
          { label: "Garden", value: "43 m²" },
          { label: "Pool", value: "12.5 m²" },
          { label: "Common Area", value: "12 m²" },
        ],
