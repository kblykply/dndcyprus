...
const ANGLES: Angle[] = [
  ...
  La Joya Perla II Materials & Details
</h2>
<p className="mt-1 text-white/80">
  <strong>Perla II</strong> is where elegance and comfort come together.
</p>
