...
subtitle = "We provide end-to-end solutions from design to delivery for residential, commercial, and mixed-use projects.",
primaryText = "Get a Quote",
primaryHref = "/en/contact",
secondaryText = "Explore Our Projects",
...
highlights = [
  ...
  return (
    <section
      aria-label="Ana Sayfa — İletişim & Broşür"
  ...
  className="mx-auto max-w-3xl rounded-2xl p-8 sm:p-10 lg:p-12 text-center shadow-[0_12px_48px_rgba(0,0,0,0.25)] ring-1"          style={{
            background:
        ...
        >
          ...
          <motion.h2
            variants={fadeUp}
            className="mt-4 text-3xl sm:text-4xl lg:text-5xl font-semibold leading-tight text-center"
          >
            {title}
          </motion.h2>
          ...
          >
            {primaryHref && primaryText && (
              <a
                href={primaryHref}
                className="rounded-xl px-6 py-3 text-sm font-semibold transition-transform duration-300 will-change-transform focus:outline-none focus:ring-2 focus:ring-white/40"
                style={{
            ...
            {secondaryHref && secondaryText && (
              <a
                href={secondaryHref}
                className="rounded-xl px-6 py-3 text-sm font-medium transition-transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-white/30"
                style={{
                  background: "rgba(255,255,255,0.10)",
                  color: "#fff",
                  border: "1px solid var(--stroke)",
