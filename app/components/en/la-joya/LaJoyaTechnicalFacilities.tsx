...
subtitle = "The privileges in our project offer you a comfortable and modern lifestyle.",
autoPlay = true,
intervalMs = 4800,
}: Props) {
  /* ---- Data (EN) ---- */
    ...
    () => [
      {
        ...
        desc:
          "With a central heating and cooling system, your ideal temperature is always within reach.",
        image: "/tec/klima.jpg",
        icon: <Wind className="h-5 w-5" />,
      },
      {
        title: "Central Generator",
        desc:
          "The central generator provides uninterrupted energy, so there’s no need to worry about potential power cuts.",
      ...
      },
      {
        ...
        desc:
          "Smart home systems that allow you to control your home remotely make everyday life easier.",
        image: "/tec/smart.jpg",
        icon: <Home className="h-5 w-5" />,
      },
      {
        title: "Underfloor Heating in Bathrooms",
        desc:
          "Underfloor heating offers maximum comfort and a pleasantly warm atmosphere in the bathroom.",
        image: "/tec/yer.jpg",
        ...
        return (
          ...
          >
            ...
            >
              ...
              {/* Alt cam panel */}
              <div
                className="absolute inset-x-4 bottom-4 rounded-2xl p-4 sm:p-5 backdrop-blur-md min-h-[200px]"
                style={{
                  background:
