...
const DEFAULT_ITEMS: Amenity[] = [
  {
    label: "Pool Bar",
    desc: "Brighten your day with refreshing drinks and enjoy a touch of luxury and fun.",
    icon: Wine,
    accent: "teal",
  },
  {
    label: "Restaurant",
    desc: "Savor a carefully curated chef’s menu for a delicious dining experience.",
    icon: Utensils,
    accent: "orange",
  },
  {
    label: "Swimming Pool",
    desc: "Make the most of your holiday time in the outdoor swimming pools.",
    icon: Waves,
    accent: "teal",
  },
  {
    label: "Gym",
    desc: "Stay fit and healthy with the gym located within La Joya.",
    icon: Dumbbell,
    accent: "orange",
  },
  {
    label: "Open Parking",
    desc: "Enjoy practical and comfortable living with dedicated open parking areas.",
    icon: Car,
    accent: "teal",
  },
];
...
export default function LaJoyaAmenitiesSection({
  kicker = "HIGHLIGHTS",
title = "La Joya Project Amenities",
subtitle = "The La Joya complex offers a wide range of amenities designed for your comfort.",
