...
export default function Perla2FloorPlans({
 title = "Floor Plans",
subtitle = "Sample plans for each apartment type. For detailed typologies and dimensions, please contact our sales team.",
...
const DEFAULT_PLANS: Plan[] = [
  {
    id: "lj-1plus0-penthouse",
    title: "1+0",
    size: "52 m² indoor • 89 m² total area",
    variants: [
      {
        name: "Studio Penthouse",
        image: "/la-joya-plan/4.png",
        areas: [
          { label: "Living Room + Kitchen", value: "32 m²" },
          { label: "WC / Bathroom", value: "6 m²" },
          { label: "Balcony", value: "7 m²" },
          { label: "Rooftop Terrace", value: "37 m²" },
          { label: "Communal Area", value: "7 m²" },
        ],
        totals: { kapali: "52 m² indoor", kullanim: "89 m² total area" },
        gallery: [],
      },
    ],
  },
  {
    id: "lj-1plus1-loft",
    title: "1+1",
    size: "71 m² indoor • 78 m² total area",
    variants: [
      {
        name: "Loft Apartment",
        image: "/la-joya-plan/5.png",
        areas: [
          { label: "Living Room", value: "38 m²" },
          { label: "Hall", value: "2 m²" },
          { label: "WC", value: "3 m²" },
          { label: "Bedroom", value: "13 m²" },
          { label: "WC / Bathroom", value: "4.5 m²" },
          { label: "Walk-in Closet", value: "3.5 m²" },
          { label: "Terrace", value: "7 m²" },
          { label: "Communal Area", value: "7 m²" },
        ],
        totals: { kapali: "71 m² indoor", kullanim: "78 m² total area" },
        gallery: [],
      },
    ],
  },
  {
    id: "lj-2plus1-penthouse",
    title: "2+1",
    size: "98 m² indoor • 172 m² total area",
    variants: [
      {
        name: "Penthouse Apartment",
        image: "/la-joya-plan/6.png",
        areas: [
          { label: "Living Room + Kitchen", value: "38 m²" },
          { label: "Hall", value: "2 m²" },
          { label: "WC / Bathroom", value: "6 m²" },
          { label: "Bedroom 1", value: "14 m²" },
          { label: "Bedroom 2", value: "14 m²" },
          { label: "Terrace", value: "14 m²" },
          { label: "Rooftop Terrace", value: "74 m²" },
          { label: "Communal Area", value: "10 m²" },
        ],
        totals: { kapali: "98 m² indoor", kullanim: "172 m² total area" },
        gallery: [],
      },
    ],
  },
