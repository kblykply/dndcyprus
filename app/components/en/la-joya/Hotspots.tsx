...
const ANGLES: Angle[] = [
  {
    ...
    imageAlt: "Interior render – Living room angle",
    hotspots: [
      // ...
    ],
  },
  {
    ...
    imageAlt: "Interior render – Kitchen angle",
    hotspots: [
      // ...
    ],
  },
  {
    ...
    imageAlt: "Interior render – Bedroom angle",
    hotspots: [
      // ...
    ],
  },
  ...
  La Joya Interior & Design
</h2>
<p className="mt-1 text-white/80">
  Holiday living and refined aesthetics come together at <strong>La Joya</strong>.
</p>
