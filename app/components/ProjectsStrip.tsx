...
const PROJECTS: Project[] = [
  {
    name: "Lagoon Verde",
    region: "İskele",
    blurb: "Modern mimari ve konforu tek çatı altında buluşturan yaşam alanları.",
  ...
  },
  {
    ...
    region: "İskele",
    blurb: "Denizle iç içe, sosyal yaşamı zenginleştiren bir konsept.",
    img: "/perla-ii/1.jpg",
    href: "/tr/perla-ii",
  },
  {
    ...
    region: "İskele",
    blurb: "Doğal dokuya saygılı, şık ve zamansız tasarım dili.",
    img: "/perla/9.jpg",
    href: "/tr/perla",
  },
  {
    name: "La Joya",
    region: "İskele",
    blurb: "Sahil hattında butik bir yaşam deneyimi.",
    img: "/la-joya/3.jpg",
    href: "/tr/la-joya",
  },
  {
    ...
    region: "İskele",
    blurb: "Akdeniz ışığını yakalayan minimal ve çağdaş çizgiler.",
    img: "/mariachi/2.jpg",
    href: "/tr/mariachi",
  },
];
