...
const PROJECT_JSON_LD = {
  ...
  url: `${SITE_URL}/tr/perla-ii`,
  description:
    "La Joya Perla II; mimarisi, planlaması ve sosyal olanakları ile Bahçeler, İskele’de modern yaşamı yeniden tanımlayan bir konut projesidir.",
...
export default function Perla2Facts({
  title = "La Joya Perla II Öne Çıkan Bilgiler",
