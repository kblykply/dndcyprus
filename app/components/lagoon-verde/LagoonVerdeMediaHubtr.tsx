...
export default function LagoonVerdeMediaHubLight({
  title = "DND Medya Merkezi",
subtitle = "Katalogları, broşürleri, videoları, kampanyaları ve dijital içerikleri keşfedin.",
  logoSrc = "/DND.png",
}: Props) {
 ...
 const items = useMemo<MenuItem[]>(
  () => [
    {
      id: "lagoon-brochure",
      title: "Lagoon Verde Broşür",
      type: "pdf",
      thumb: "/lagoonflip/l-01.webp",
      src: "/lagoonbrotr.pdf",
      description: "Lagoon Verde broşürü",
    },
     {
      ...
      thumb: "/lagoon-verde/3.jpg",

      src: "/dndtum.pdf",

      description: "DND genel broşürü",
    ...
    },
    {
      ...
      description: "Lagoon Verde videosu",
    },
    {
      id: "kktc-video",
      title: "KKTC Video",
      ...
      description: "Kuzey Kıbrıs tanıtım videosu",
    },
    {
      id: "kktc-catalog",
      title: "KKTC Katalog",
      ...
      thumb: "/kktc.png",
      src: "/kktckattr.pdf",
      description: "Kuzey Kıbrıs kataloğu",
    },
    {
      id: "la-joya-video",
      title: "La Joya Video",
      ...
      src: "https://www.youtube.com/embed/bKNPhMFNzGY?si=bAsOzWd2Kr6O8Fy-",
      description: "La Joya Polonya videosu",
    },
    {
      id: "dnd-website",
      title: "DND Cyprus Web Sitesi",
      type: "link",
      thumb: "/dndweb.png",
      src: "https://dndcyprus.com/tr",
      description: "DND Cyprus resmi web sitesi",
    },
    {
      id: "property-awards",
      title: "Property Awards Videosu",
      type: "instagram",
      thumb: "/property_awards_2025-747.jpg",
      src: "https://www.instagram.com/reel/DJLqfFSA4dP/",
      description: "Property Awards videosu",
    },
    {

      id: "property-awards-image",
      ...
      description: "Property Awards görseli",

    },

    {
      id: "payment-plan",
      title: "Lagoon Verde Ödeme Planı",
      type: "pdf",
      thumb: "/lagoon-verde/1.jpg",
      src: "/paymentt.pdf",
      description: "Lagoon Verde ödeme planı",
    },
    {
      id: "campaign",
      title: "Kampanya",
