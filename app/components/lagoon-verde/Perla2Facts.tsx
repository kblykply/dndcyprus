...
const PROJECT_JSON_LD = {
  ...
  name: "Lagoon Verde",
  url: `${SITE_URL}/tr/lagoon-verde`,
  description:
    "Lagoon Verde; eşsiz lagün havuzu konsepti, modern mimarisi ve zengin sosyal donatıları ile Bahçeler, İskele’de tatil ve yaşamı yeniden tanımlayan prestijli bir konut projesidir.",
